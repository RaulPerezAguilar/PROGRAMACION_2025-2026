...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        EventoMusical eventoBuscado = em.find(EventoMusical.class, idEvento1);
        ...
        EventoMusical resultado1 = consultaEstatica.getSingleResult();
        ...
        EventoMusical resultado2 = consultaDinamica.getSingleResult();
